...
var sValorCapturado="", sErr="";
			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
                   ...
                   //mostra fondo verde en el input text cuan es correcta la respuestas  
                        document.getElementById("txtResultado"+i).style.background="#3CE923";
                        document.getElementById("txtResultado"+i).style.color="white";
                        document.getElementById("txtResultado"+i).style.textAlign="center";
                    }else{
                     //mostra fondo incorrecta en el input text cuan es correcta la respuestas 
                        document.getElementById("txtResultado"+i).style.background="#BB150E";  
                        document.getElementById("txtResultado"+i).style.color="white";
                        document.getElementById("txtResultado"+i).style.textAlign="center";
                    }
               }
	...
	if (sErr == "")
        if(nCalif>7)
		alert("Calif = "+nCalif+" Aprobado");
        else
        alert("Calif = "+nCalif+" Reprobado");
	else
		alert(sErr);
}
